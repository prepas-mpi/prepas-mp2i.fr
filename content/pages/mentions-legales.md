...
Le nom de domaine prepas-mp2i.fr a été acquis le 3 février 2022 chez la société [OVH SAS](https://ovh.com/), qui se réserve le droit de suspendre l'accès au nom de domaine prepas-mp2i.fr.
...
<div id="matomo-opt">
    ...
    <div id="matomo-opt-out">
        <script onerror="document.getElementById('matomo-opt').style.display = 'none'" src="https://matomo.prepas-mp2i.fr/index.php?module=CoreAdminHome&action=optOutJS&divId=matomo-opt-out&language=auto&showIntro=0"></script>
    </div>
</div>
